...
CREATE TABLE IF NOT EXISTS `mytp`.`Tariff` (
  ...
  `price` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_tariff`, `id_type`),
  INDEX `fk_Tariff_1_idx` (`id_type` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mytp`.`Address` (
  ...
  `name` VARCHAR(45) NOT NULL,
  `type` INT NOT NULL,
  PRIMARY KEY (`id_address`, `type`),
  INDEX `fk_Adress_1_idx` (`type` ASC) ,
  INDEX `fk_Address_1_idx` (`id_include` ASC) ,
  ...
  CONSTRAINT `fk_Address_1`
    ...
    REFERENCES `mytp`.`Address` (`id_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mytp`.`Personal_account` (
  `id_personal_account` VARCHAR(30) NOT NULL,
  `id_address` INT NOT NULL,
  `id_owner_user` INT NOT NULL,
  PRIMARY KEY (`id_personal_account`, `id_owner_user`),
  INDEX `fk_Personal_account_1_idx` (`id_owner_user` ASC) ,
  INDEX `fk_Personal_account_2_idx` (`id_address` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mytp`.`Metrics` (
  ...
  PRIMARY KEY (`id_metrics`, `id_type`, `id_tariff`),
  INDEX `fk_Metrics_2_idx` (`id_tariff` ASC) ,
  INDEX `fk_Metrics_1_idx` (`id_personal_account` ASC) ,
  INDEX `fk_Metrics_3_idx` (`id_type` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mytp`.`User_metrics` (
  ...
  PRIMARY KEY (`id_user_metrics`, `id_metrics`, `id_user`),
  INDEX `fk_User_metrics_2_idx` (`id_metrics` ASC) ,
  INDEX `fk_User_metrics_1_idx` (`id_user` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mytp`.`Payment_history` (
  ...
  INDEX `fk_Check_1_idx` (`id_metrics` ASC),
  INDEX `fk_Check_2_idx` (`id_user` ASC) ,
